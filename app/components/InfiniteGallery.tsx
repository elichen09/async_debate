  ...
  return new THREE.ShaderMaterial({
    ...
    fragmentShader: `
      ...
      void main() {
        ...
        // Simple blur approximation. A fixed texel size keeps this shader valid
        // as GLSL ES 1.0 (textureSize() requires GLSL ES 3.0, which three's
        // default ShaderMaterial does not compile to).
        if (blurAmount > 0.0) {
...
function GalleryScene({
  ...
  // Photos are authored in sRGB; tag them so colors render true.
  useEffect(() => {
